...
def weighted_distance_merit(
    npts, surrogate, X, fX, cand, weights, Xpend=None, dtol=1e-3):
...
def make_srbf(
    npts, opt_prob, surrogate, X, fX, Xpend=None, sampling_radius=0.2,
    weights=None, subset=None, dtol=1e-3, num_cand=None):
    ...
    return weighted_distance_merit(
        npts=npts, surrogate=surrogate, X=X, fX=fX, Xpend=Xpend, 
        cand=cand, dtol=dtol, weights=weights)
