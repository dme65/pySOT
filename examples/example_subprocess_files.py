...
import numpy as np
from poap.controller import ProcessWorkerThread, ThreadController

from pySOT.experimental_design import SymmetricLatinHypercube
from pySOT.optimization_problems import Sphere
from pySOT.strategy import SRBFStrategy
from pySOT.surrogate import LinearTail, RBFInterpolant, TPSKernel
...
def example_subprocess_files():
    ...
    logging.basicConfig(filename="./logfiles/example_subprocess_files.log", level=logging.INFO)
    ...
    controller.strategy = SRBFStrategy(
        max_evals=max_evals, opt_prob=sphere, exp_design=slhd, surrogate=rbf, asynchronous=False, batch_size=num_threads
    )
