...
def example_subprocess():
    ...
    logging.basicConfig(filename="./logfiles/example_subprocess.log", level=logging.INFO)
    ...
    controller.strategy = SRBFStrategy(
        max_evals=max_evals, opt_prob=sphere, exp_design=slhd, surrogate=rbf, asynchronous=True, batch_size=num_threads
    )
