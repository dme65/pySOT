...
\usepackage{fancyhdr}
	...
	\fancyhead{}
	\fancyfoot{}
	\fancyhead[C]{Surrogate Optimization Toolbox in Python (pySOT) - 0.1.14 $\bullet$ Tutorial $\bullet$ David Eriksson, David Bindel, Christine Shoemaker $\bullet$ \today}
...
\title{\vspace{-15mm}%
	...
	\textbf{Surrogate Optimization Toolbox (pySOT) - 0.1.14 \\ Tutorial}
	}	
\author{%
